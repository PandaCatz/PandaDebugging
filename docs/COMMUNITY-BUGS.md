...
| 3 | **UART IRQ clear on disable** | disabling the serial port leaves TX/RX IRQs pending → spurious IRQs / startup lockups | ⬜ pending (needs the UART model; the interrupt controller is ready) |
